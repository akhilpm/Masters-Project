...
def load_dataset(num_patches, patch_size, trainX):
...
def execute_sparse_autoencoder(trainX):
	...
	data_train = load_dataset(num_patches, input_patch_size, trainX)
