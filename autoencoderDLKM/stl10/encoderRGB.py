...
def load_dataset(num_patches, patch_size):
	...
	dataset = np.zeros((patch_size*patch_size*3, num_patches))
...
def execute_sparse_autoencoder():
	...
	hidden_patch_size = 25 #size of representative image patches
	rho = 0.9 			  # sparsity parameter(desired avg activation of hidden units)
